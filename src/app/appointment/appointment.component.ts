...
export class AppointmentComponent implements OnInit{
  ...
  submitTheAppointment()
  {
    ...
    this.obj.appointmentDate = new Date(this.obj.appointmentDate);
    if(this.route.snapshot.params['id'])
    {
      this.data.updateTheAppointment(this.obj, this.route.snapshot.params['id']).subscribe(Response=>{this.router.navigate(['/appointmentList']);});
    }else
    {
      this.obj.appointmentId = undefined;
      this.data.updateTheAppointment(this.obj , 0).subscribe(Response=>{this.router.navigate(['/appointmentList']);});
    }
  }
